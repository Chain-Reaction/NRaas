...
{
    public class FlyHereEx : Jetpack.FlyHere, Common.IPreLoad, Common.IAddInteraction
    {
        static InteractionDefinition sOldSingleton;

        public void OnPreLoad()
        {
            Tunings.Inject<Terrain, Jetpack.FlyHere.Definition, Definition>(false);
        ...
        {
            interactions.Replace<Terrain, Jetpack.FlyHere.Definition>(Singleton);
        }

        private new class Definition : Jetpack.FlyHere.Definition
        {
            public Definition()
            { }
            ...
            {
                InteractionInstance na = new FlyHereEx();
