...
{
    public class WaterskiHereEx : WaterskiHere, Common.IPreLoad, Common.IAddInteraction
    {
        static InteractionDefinition sOldSingleton;

        public void OnPreLoad()
        {
            Tunings.Inject<Terrain, WaterskiHere.Definition, Definition>(false);
        ...
        {
            interactions.Replace<Terrain, WaterskiHere.Definition>(BoatSingleton);
        }
        ...
        private new class Definition : WaterskiHere.Definition
        {
            public Definition()
            { }
            ...
            {
                InteractionInstance na = new WaterskiHereEx();
