...
{
    public class ActivateRendezvous : Computer.ComputerInteraction, Common.IAddInteraction
    {
        ...
        public sealed class Definition : InteractionDefinition<Sim, Computer, ActivateRendezvous>
        {
            public override string GetInteractionName(Sim actor, Computer target, InteractionObjectPair iop)
            {
                ...
                if (skill.RendezvousActive)
                {
                    return Common.Localize("DisableRendezvous:MenuName");
                }
                else
                {
                    return Common.Localize("EnableRendezvous:MenuName");
                }
            }
            ...
            {
                if (!KamaSimtra.Settings.mShowRendezvousInteraction) return false;
