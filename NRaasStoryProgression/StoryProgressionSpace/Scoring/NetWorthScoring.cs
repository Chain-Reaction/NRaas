...
{
    public class NetWorthScoring : HitMissScoring<SimDescription, SimScoringParameters, SimScoringParameters>, IScoring<SimDescription, DualSimScoringParameters>
    {
        HitMissResult<SimDescription, SimScoringParameters> mGate;

        public NetWorthScoring()
        { }
