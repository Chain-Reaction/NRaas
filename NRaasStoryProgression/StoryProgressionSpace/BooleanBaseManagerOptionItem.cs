...
{
    public abstract class BooleanBaseManagerOptionItem<TManager> : BooleanOptionItem, IStoryProgressionUpdater, IInstallable<TManager>
        where TManager : StoryProgressionObject
    {
        TManager mManager;

        public BooleanBaseManagerOptionItem(bool value)
            : base(value)
        { }
