...
{
    public abstract class IntegerEventOptionItem<TManager, TScenario> : IntegerManagerOptionItem<TManager>, IScenarioOptionItem
        where TManager : Manager
        where TScenario : Scenario, IEventScenario, new()
    {
        public IntegerEventOptionItem(int value)
            : base(value)
        { }
