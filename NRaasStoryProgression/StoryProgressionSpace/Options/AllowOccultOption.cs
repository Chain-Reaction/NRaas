...
{
    public class AllowOccultOption : OccultTypeOption, IReadSimLevelOption, IWriteSimLevelOption, IHouseLevelSimOption        
    {
        public AllowOccultOption()
        ...
        {
            List<SimType> results = base.GetOptions() as List<SimType>;

            foreach (SimType type in results)
            {
                switch (type)
                {
                    case SimType.None:
