...
{
    public class ChanceOfOccultOption<TManager> : IntegerBaseManagerOptionItem<TManager>, ISimFromBinOption<TManager>
        where TManager : StoryProgressionObject, ISimFromBinManager
    {
        SimFromBinController mController;

        public ChanceOfOccultOption()
            : base(0)
        { }

        public override string GetTitlePrefix()
        {
            return "ChanceOfOccult";
        }
