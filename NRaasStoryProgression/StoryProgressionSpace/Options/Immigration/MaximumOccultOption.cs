...
{
    public class MaximumOccultOption<TManager> : IntegerBaseManagerOptionItem<TManager>, ISimFromBinOption<TManager>
        where TManager : StoryProgressionObject, ISimFromBinManager
    {
        SimFromBinController mController;

        public MaximumOccultOption()
            : base(0)
        { }

        public override string GetTitlePrefix()
        {
            return "MaximumOverOccult";
        }
