...
{
    public class MaximumBinHouseSizeOption<TManager> : IntegerBaseManagerOptionItem<TManager>, ISimFromBinOption<TManager>
        where TManager : StoryProgressionObject, ISimFromBinManager
    {
        SimFromBinController mController;

        public MaximumBinHouseSizeOption()
            : base(25)
        { }

        public override string GetTitlePrefix()
        {
            return "MaximumBinHouseSize";
        }
