...
{
    public class MuscleRangeOption<TManager> : RangeBaseManagerOptionItem<TManager>, ISimFromBinOption<TManager>
        where TManager : StoryProgressionObject, ISimFromBinManager
    {
        SimFromBinController mController;

        public MuscleRangeOption()
            : base(new Vector2(0, 1), new Vector2(0, 1))
        { }

        public override string GetTitlePrefix()
        {
            return "RandomSimMuscleRange";
        }
