...
{
    public class EqualBinChanceOption<TManager> : BooleanBaseManagerOptionItem<TManager>, ISimFromBinOption<TManager>
        where TManager : StoryProgressionObject, ISimFromBinManager
    {
        SimFromBinController mController;

        public EqualBinChanceOption()
            : base(true)
        { }

        public override string GetTitlePrefix()
        {
            return "EqualChancetoAllBinSims";
        }
