...
{
    public class MutationUnsetRangeOption<TManager> : RangeBaseManagerOptionItem<TManager>, ISimFromBinOption<TManager>
        where TManager : StoryProgressionObject, ISimFromBinManager
    {
        SimFromBinController mController;

        public MutationUnsetRangeOption()
            : base(new Vector2(-0.1f, 0.1f), new Vector2(-1f, 1f))
        { }

        public override string GetTitlePrefix()
        {
            return "MutationUnsetRange";
        }
