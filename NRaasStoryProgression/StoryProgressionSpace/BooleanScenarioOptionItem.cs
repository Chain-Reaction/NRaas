...
{
    public abstract class BooleanScenarioOptionItem<TManager,TScenario> : BooleanManagerOptionItem<TManager>, IScenarioOptionItem
        where TManager : Manager
        where TScenario : Scenario, new()
    {
        public BooleanScenarioOptionItem(bool value)
            : base(value)
        { }
