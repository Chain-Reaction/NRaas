...
{
    public class ExistingFriendManualScenario : ExistingFriendScenario
    {
        string mStoryName = null;

        public ExistingFriendManualScenario(SimDescription sim, SimDescription target, int delta, int reportChance)
        ...
        protected ExistingFriendManualScenario(ExistingFriendManualScenario scenario)
            : base (scenario)
        {
        ...
        {
            return new ExistingFriendManualScenario(this);
        }
    }
}
