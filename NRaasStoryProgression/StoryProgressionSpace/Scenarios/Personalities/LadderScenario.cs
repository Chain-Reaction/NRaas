...
{
    public class LadderScenario : PromoteScenario, IHasPersonality
    {
        WeightOption.NameOption mName = null;

        WeightScenarioHelper mSuccess = null;

        bool mGiveRaise = true;

        public LadderScenario()
        { }
        ...
        public override string ToString()
        {
            ...
            text += Common.NewLine + "GiveRaise=" + mGiveRaise;
        ...
        protected override bool GiveRaise
        {
            get { return mGiveRaise; }
        }
        ...
        {
            return new LadderScenario(this);
        }
    }
}
