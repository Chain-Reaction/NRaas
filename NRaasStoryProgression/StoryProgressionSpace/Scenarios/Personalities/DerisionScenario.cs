...
{
    public class DerisionScenario : RelationshipScenario, IHasPersonality
    {
        ...
        protected override bool PrivateUpdate(ScenarioFrame frame)
        {
            ...
            mNemesis = ExistingEnemyScenario.HandleNemesis(Sim, Target);
        ...
        {
            return new DerisionScenario(this);
        }
    }
}
