...
{
    public class InspectedScoredMoveInScenario : ScoredMoveInScenario
    {
        public InspectedScoredMoveInScenario(SimDescription sim, List<SimDescription> going)
            : base(sim, going)
        { }
        protected InspectedScoredMoveInScenario(InspectedScoredMoveInScenario scenario)
            : base(scenario)
        { }
        ...
        {
            return new InspectedScoredMoveInScenario(this);
        }
    }
}
