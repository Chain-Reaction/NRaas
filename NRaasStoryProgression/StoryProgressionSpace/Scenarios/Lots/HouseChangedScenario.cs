...
namespace NRaas.StoryProgressionSpace.Scenarios.Lots
{
    public class HouseChangedScenario : HouseChangedBaseScenario
    {
        ...
        {
            Lots.ClearWorth(OldHouse);
            Lots.ClearWorth(NewHouse);
            return false;
        }
        ...
        public class Option : BooleanEventOptionItem<ManagerLot, HouseChangedScenario>, IDebuggingOption
        {
            public Option()
                : base(true)
            { }
