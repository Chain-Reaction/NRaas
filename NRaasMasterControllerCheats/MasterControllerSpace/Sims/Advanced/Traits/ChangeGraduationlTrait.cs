...
{
    public class ChangeGraduationTrait : SimFromList, ITraitOption
    {
        public override string GetTitlePrefix()
        {
            return "ChangeGraduationTrait";
        }
        ...
        protected override bool PrivateAllow(SimDescription me)
        {
            ...
            //if (!me.TraitManager.mUniversityGraduateTraitEnabled) return false;
