...
{
    public class RadiusPurge : OptionItem, IObjectOption
    {
        ...
        {
            if (!MasterController.Settings.mMenuVisibleRadiusPurge) return false;
        ...
        {
            return new VectorProcessor(GetTitlePrefix(), parameters.mHit.mPoint).Perform(ObjectStats.OnFlush);
        }
    }
}
