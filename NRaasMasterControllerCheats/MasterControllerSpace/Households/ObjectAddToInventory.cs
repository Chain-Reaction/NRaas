...
{
    public class ObjectAddToInventory : HouseholdFromList, IHouseholdOption
    {
        ...
        protected override OptionResult RunAll(List<LotHouseItem> houses)
        {
            ...
            return new LotProcessor("RadiusAddToInventory", lots).Perform(Town.ObjectAddToInventory.OnAddToInventory);
        }
