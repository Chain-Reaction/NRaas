...
{
    public class ResumeTone : AnimationTone
    {
        public ResumeTone()
        { }
        ...
        public override bool Test(InteractionInstance ii, out StringDelegate reason)
        {
            try
            {
                ...
                if (!interaction.Paused)
                {
                    reason = delegate
                    {
                        return Common.Localize("Resume:Disabled");
                    };
        ...
        {
            return Common.Localize("Resume:MenuName");
        }

        public override string Description()
        {
            return Common.Localize("Resume:Description");
        }
    }
}