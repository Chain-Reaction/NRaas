...
{
    public class RemoveSpecialMerchant : OperationSettingOption<GameObject>, IGlobalRolesOption
    {
        public override string GetTitlePrefix()
        {
            return "RemoveSpecialMerchant";
        }
        ...
        protected class SimSelection : ProtoSimSelection<SimDescription>
        {
            ...
            protected override bool Allow(SimDescription sim)
            {
                ...
                return (sim.AssignedRole is RoleSpecialMerchant);
            }
        }
    }
}