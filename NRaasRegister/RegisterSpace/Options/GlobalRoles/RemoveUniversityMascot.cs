...
{
    public class RemoveUniversityMascot : OperationSettingOption<GameObject>, IGlobalRolesOption
    {
        public override string GetTitlePrefix()
        {
            return "RemoveUniversityMascot";
        }
        ...
        protected class SimSelection : ProtoSimSelection<SimDescription>
        {
            ...
            {
                if (sim.AssignedRole == null) return false;

                return (sim.AssignedRole is UniversityMascotRole);
            }
        }
    }
}