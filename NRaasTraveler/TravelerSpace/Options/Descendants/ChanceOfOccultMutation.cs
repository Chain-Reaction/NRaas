...
{
    public class ChanceOfOccultMutation : IntegerSettingOption<GameObject>, IDescendantOption
    {
        protected override int Value
        {
            get
            {
                return Traveler.Settings.mChanceOfOccultMutation;
            }
            set
            {
                Traveler.Settings.mChanceOfOccultMutation = value;               
            }
        }
        ...
        {
            /*
            int value = Traveler.Settings.mChanceOfOccultMutation;
