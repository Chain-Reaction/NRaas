...
{
    public class ChanceOfOccultHybrid : IntegerSettingOption<GameObject>, IDescendantOption
    {
        protected override int Value
        {
            get
            {
                return Traveler.Settings.mChanceOfOccultHybrid;
            }
            set
            {
                Traveler.Settings.mChanceOfOccultHybrid = value;
            }
        }

        public override string GetTitlePrefix()
        {
            return "ChanceOfOccultHybrid";
        }        

        protected override OptionResult Run(GameHitParameters<GameObject> parameters)
        {
            /*
            int value = Traveler.Settings.mChanceOfOccultHybrid;
            ...
            Traveler.Settings.mChanceOfOccultHybrid = mCount;
