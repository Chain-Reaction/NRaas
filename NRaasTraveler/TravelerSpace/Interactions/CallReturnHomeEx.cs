...
{
    public class CallReturnHomeEx : Phone.CallReturnHome, Common.IPreLoad, Common.IAddInteraction
    {
        static InteractionDefinition sOldSingleton;

        public void OnPreLoad()
        {
            InteractionTuning tuning = Tunings.Inject<Phone, Phone.CallReturnHome.Definition, Definition>(false);
            if (tuning != null)
            {
        ...
        {
            interactions.Replace<Phone, Phone.CallReturnHome.Definition>(Singleton);
        }

        public new class Definition : Phone.CallReturnHome.Definition
        {
            ...
            {
                InteractionInstance na = new CallReturnHomeEx();
