...
{
    public class AncientPortalTimeTravelWithEx : AncientPortal.CatchABeam, ITravelWith, Common.IPreLoad, Common.IAddInteraction
    {
        ...
        public new class Definition : AncientPortal.CatchABeam.Definition
        {
            ...
            {
                InteractionInstance na = new AncientPortalTimeTravelWithEx();
