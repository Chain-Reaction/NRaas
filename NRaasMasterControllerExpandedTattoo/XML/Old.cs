public class CASTattoo : CASUnderwear, ICASUINode
{
    ...
    [Tunable, TunableComment("Default AnkleRight Scale")]
    public static float kDefaultAnkleRightScales = 0.5f;
    [TunableComment("Default Bellybutton Scale"), Tunable]
    ...
    [Tunable, TunableComment("Default BicepRight Scale")]
    ...
    [Tunable, TunableComment("Default ForearmRight Scale")]
    ...
    [Tunable, TunableComment("Default ShoulderRight Scale")]
    public static float kDefaultShoulderRightScales = 0.5f;
    [Tunable, TunableComment("Default UpperBack Scale")]
    ...
    [TunableComment("Default WristRight Scale"), Tunable]
    ...
    {
        this.ActiveLayer = 0x0;
        if (this.mNavButtons[ControlIDs.AnkleGroupButton].Selected)
        {
            ...
            {
                this.SetActiveTattooType(TattooID.TattooNone | TattooID.TattooAnkleLeft, false);
            }
            else
            {
        ...
        else if (this.mNavButtons[ControlIDs.ArmGroupButton].Selected)
        {
            ...
            if (this.mNavButtons[ControlIDs.WristButton].Selected)
            {
                if (this.mNavButtons[ControlIDs.LeftButton].Selected)
                {
                    this.SetActiveTattooType(TattooID.TattooNone | TattooID.TattooWristTopLeft, false);
                }
                else
                {
                    this.SetActiveTattooType(TattooID.TattooNone | TattooID.TattooWristTopRight, false);
                }
            }
            ...
            else if (this.mNavButtons[ControlIDs.ShoulderButton].Selected)
            {
                if (this.mNavButtons[ControlIDs.LeftButton].Selected)
                {
                    this.SetActiveTattooType(TattooID.TattooShoulderLeft, false);
                }
                else
                {
                    this.SetActiveTattooType(TattooID.TattooShoulderRight, false);
                }
            }
        }
        else if (this.mNavButtons[ControlIDs.ChestGroupButton].Selected)
        {
            this.LeftRightEnabled = false;
            this.mArmPanel.Visible = false;
            this.mChestPanel.Visible = true;
            this.mBackPanel.Visible = false;
            if (this.mNavButtons[ControlIDs.ChestButton].Selected)
            {
                this.SetActiveTattooType(TattooID.TattooChest, false);
            }
            else if (this.mNavButtons[ControlIDs.BellyButton].Selected)
            {
                this.SetActiveTattooType(TattooID.TattooBellybutton, false);
            }
        }
    ...
    {
        this.mTunedScales.Add(TattooID.TattooNone | TattooID.TattooAnkleLeft, kDefaultAnkleLeftScales);
        this.mTunedScales.Add(TattooID.TattooNone | TattooID.TattooAnkleRight, kDefaultAnkleRightScales);
        this.mTunedScales.Add(TattooID.TattooBellybutton, kDefaultBellybuttonScales);
        ...
        this.mTunedScales.Add(TattooID.TattooChest, kDefaultChestScales);
        ...
        this.mTunedScales.Add(TattooID.TattooShoulderLeft, kDefaultShoulderLeftScales);
        this.mTunedScales.Add(TattooID.TattooShoulderRight, kDefaultShoulderRightScales);
        this.mTunedScales.Add(TattooID.TattooUpperBack, kDefaultUpperBackScales);
        this.mTunedScales.Add(TattooID.TattooNone | TattooID.TattooWristTopLeft, kDefaultWristLeftScales);
        this.mTunedScales.Add(TattooID.TattooNone | TattooID.TattooWristTopRight, kDefaultWristRightScales);
    }
