...
{
    public class ReadBookChooserEx : Common.IPreLoad, Common.IAddInteraction
    {
        ...
        {
            Tunings.Inject<Book, ReadBookChooser.Definition, Definition>(false);

            ReadBookChooser.Singleton = Singleton;
        }

        public class Definition : ReadBookChooser.Definition
        {
        ...
        public class CustomInjector : Common.InteractionReplacer<Book, ReadBookChooser.Definition>
        {
