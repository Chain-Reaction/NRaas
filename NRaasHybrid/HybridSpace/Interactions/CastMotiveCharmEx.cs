...
{
    public class CastMotiveCharmEx : MagicWand.CastMotiveCharm, IMagicalInteraction, Common.IPreLoad, Common.IAddInteraction
    {
        static InteractionDefinition sOldSingleton;

        CastSpellProxy<CastMotiveCharmEx> mProxy = new CastSpellProxy<CastMotiveCharmEx>();

        public void OnPreLoad()
        {
            Tunings.Inject<Sim, MagicWand.CastMotiveCharm.Definition, Definition>(false);

            sOldSingleton = MagicWand.CastMotiveCharm.Singleton;
            MagicWand.CastMotiveCharm.Singleton = new Definition();
        }

        public void AddInteraction(Common.InteractionInjectorList interactions)
        {
            interactions.Replace<Sim, MagicWand.CastMotiveCharm.Definition>(MagicWand.CastMotiveCharm.Singleton);
        }
        ...
        public new class Definition : MagicWand.CastMotiveCharm.Definition, IMagicalDefinition
        {
            ...
            {
                InteractionInstance na = new CastMotiveCharmEx();
        ...
        public class HungerDefinition : IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get { return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kMotiveCharmUnlockLevels[0x1], CastMotiveCharmEx.kMotiveDrain, 0); }
            }
        ...
        public class BladderDefinition : IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get { return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kMotiveCharmUnlockLevels[0x0], CastMotiveCharmEx.kMotiveDrain, 0); }
            }
        ...
        public class EnergyDefinition : IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get { return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kMotiveCharmUnlockLevels[0x2], CastMotiveCharmEx.kMotiveDrain, 0); }
            }
        ...
        public class SocialDefinition : IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get { return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kMotiveCharmUnlockLevels[0x5], CastMotiveCharmEx.kMotiveDrain, 0); }
            }
        ...
        public class HygieneDefinition : IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get { return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kMotiveCharmUnlockLevels[0x3], CastMotiveCharmEx.kMotiveDrain, 0); }
            }
        ...
        public class FunDefinition : IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get { return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kMotiveCharmUnlockLevels[0x4], CastMotiveCharmEx.kMotiveDrain, 0); }
            }
