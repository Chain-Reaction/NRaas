...
{
    public class UnicornDespawnEx : Common.IPreLoad, Common.IAddInteraction
    {
        ...
        {
            interactions.Replace<Sim, OccultUnicorn.UnicornDespawn.Definition>(OccultUnicorn.UnicornDespawn.Singleton as InteractionDefinition);
        }

        public class Definition : OccultUnicorn.UnicornDespawn.Definition
        {
            public Definition()
            { }
