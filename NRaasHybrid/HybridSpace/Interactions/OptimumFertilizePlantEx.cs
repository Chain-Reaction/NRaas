...
{
    public class OptimumFertilizePlantEx : Common.IPreLoad, Common.IAddInteraction
    {
        ...
        {
            interactions.Replace<Plant, Plant.OptimumFertilizePlant.Definition>(Plant.OptimumFertilizePlant.Singleton);
        }

        public class Definition : Plant.OptimumFertilizePlant.Definition
        {
            public Definition()
            { }
