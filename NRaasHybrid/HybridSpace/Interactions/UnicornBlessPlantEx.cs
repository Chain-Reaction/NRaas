...
{
    public class UnicornBlessPlantEx : Common.IPreLoad, Common.IAddInteraction
    {
        ...
        {
            interactions.Replace<HarvestPlant, OccultUnicorn.UnicornBlessPlant.BlessPlantDefinition>(OccultUnicorn.UnicornBlessPlant.Singleton);
        }

        public class Definition : OccultUnicorn.UnicornBlessPlant.BlessPlantDefinition
        {
            public Definition()
            { }
