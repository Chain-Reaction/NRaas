...
{
    public class RemoveMermaidWithVortexEx : Common.IPreLoad, Common.IAddInteraction
    {
        ...
        {
            interactions.Replace<Sim, OccultMermaid.RemoveMermaidWithVortex.Definition>(OccultMermaid.RemoveMermaidWithVortex.Singleton as InteractionDefinition);
        }

        public class Definition : OccultMermaid.RemoveMermaidWithVortex.Definition
        {
            public Definition()
            { }
