...
{
    public class WerewolfHuntEx : Common.IPreLoad, Common.IAddInteraction
    {
        ...
        {
            interactions.Replace<Sim, OccultWerewolf.WerewolfHunt.Definition>(OccultWerewolf.WerewolfHunt.Singleton as InteractionDefinition);
        }

        public class Definition : OccultWerewolf.WerewolfHunt.Definition
        {
            public Definition()
            { }
