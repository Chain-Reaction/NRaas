...
{
    public class CastGoodLuckCharmEx : MagicWand.CastGoodLuckCharm, IMagicalInteraction, Common.IPreLoad, Common.IAddInteraction
    {
        static InteractionDefinition sOldSingleton;

        CastSpellProxy<CastGoodLuckCharmEx> mProxy = new CastSpellProxy<CastGoodLuckCharmEx>();
        ...
        public new class Definition : MagicWand.CastGoodLuckCharm.Definition, IMagicalDefinition
        {
            ...
            public PersistedSettings.SpellSettings DefaultSettings
            {
                get
                {
                    return new PersistedSettings.SpellSettings(OccultTypes.Witch, MagicWand.kSpellLevels[0x0], CastFireBlastEx.kMotiveDrain, 0);
                }
            }
