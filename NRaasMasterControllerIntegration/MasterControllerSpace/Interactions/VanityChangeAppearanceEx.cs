...
{
    public class VanityChangeAppearanceEx : VanityDresser.ChangeAppearance, Common.IPreLoad, Common.IAddInteraction
    {
        ...
        public new class Definition : VanityDresser.ChangeAppearance.Definition
        {
