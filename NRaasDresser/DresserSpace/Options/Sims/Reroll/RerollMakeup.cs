...
{
    public class RerollMakeup : OperationSettingOption<Sim>, IRerollOption
    {
        ...
        protected override OptionResult Run(GameHitParameters<Sim> parameters)
        {
            ...
            RemovePartsOutfitTask.Perform(parameters.mTarget, CASParts.sMakeup, false, delegate 
            {
                Dresser.Settings.RemoveTested(parameters.mTarget.SimDescription, CheckOutfitTask.ProcessOptions.Makeup);
                CheckOutfitTask.Controller.AddToQueue(parameters.mTarget.SimDescription, CheckOutfitTask.ProcessOptions.Makeup); 
            });
