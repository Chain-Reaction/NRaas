...
{
    public class RerollHair : OperationSettingOption<Sim>, IRerollOption
    {
        public override string GetTitlePrefix()
        {
            return "RerollSimHair";
        }
        ...
        protected override OptionResult Run(GameHitParameters<Sim> parameters)
        {
            ...
            CheckOutfitTask.Controller.AddToQueue(parameters.mTarget.SimDescription, CheckOutfitTask.ProcessOptions.Hair);
