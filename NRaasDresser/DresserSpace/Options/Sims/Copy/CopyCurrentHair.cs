...
{
    public class CopyCurrentHair : OperationSettingOption<Sim>, ICopyOption
    {
        public override string GetTitlePrefix()
        {
            return "CopyCurrentHair";
        }
        ...
        protected override OptionResult Run(GameHitParameters<Sim> parameters)
        {
            ...
            ProcessOutfitTask.Perform(parameters.mTarget, types, new CASParts.Key(parameters.mTarget), null);
