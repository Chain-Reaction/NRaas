...
{
    public class CheckHarvestPlantFrostable : Check<HarvestPlantFrostable>
    {
        public static Dictionary<Vector3, IngredientInitParameters> sMissingPlants = new Dictionary<Vector3, IngredientInitParameters>();

        protected override bool PrePerform(HarvestPlantFrostable plant, bool postLoad)
        {
            return true;
        }

        protected override bool PostPerform(HarvestPlantFrostable plant, bool postLoad)
        {
