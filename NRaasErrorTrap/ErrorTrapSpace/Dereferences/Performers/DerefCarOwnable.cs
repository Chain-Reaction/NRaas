...
{
    public class DerefCarOwnable : Dereference<CarOwnable>
    {
        protected override DereferenceResult Perform(CarOwnable reference, FieldInfo field, List<ReferenceWrapper> objects)
        {
