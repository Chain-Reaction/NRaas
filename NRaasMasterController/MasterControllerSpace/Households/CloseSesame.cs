...
{
    public class CloseSesame : HouseholdFromList, IHouseholdOption
    {
        ...
        public static OptionResult Perform(Lot lot)
        {
            ...
            if (lot.IsCommunityLot)
            {
                ...
                Camera.sActiveLotOverride = null;

                CameraController.Untether();
            }
            else
            {
                Household active = Household.ActiveHousehold;
                ...
                active.RemoveGreetedLotForHousehold(lot, ObjectGuid.InvalidObjectGuid);
            }
