...
{
    public class SimDescriptionInteraction : ListedInteraction<ISimOption, SimDescriptionObject>
    {
        public static InteractionDefinition Singleton = new CommonDefinition<SimDescriptionInteraction>();
