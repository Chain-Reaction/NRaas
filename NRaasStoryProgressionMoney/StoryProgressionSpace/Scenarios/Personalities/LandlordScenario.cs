...
{
    public class LandlordScenario : CohesionScenario
    {
        public LandlordScenario()
        { }
        protected LandlordScenario(LandlordScenario scenario)
            : base (scenario)
        { }
        ...
        {
            return new LandlordScenario(this);
        }
    }
}
