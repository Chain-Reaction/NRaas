...
{
    public class FPSCapSetting : FloatSettingOption<GameObject>, ISettingOption
    {
        public override string GetTitlePrefix()
        {
            return "FPSCapSetting";
        }
        ...
        protected override float Value
        {
            get
            {
                return NRaas.Overwatch.Settings.mFPSCap;
            }
            set
            {
                NRaas.Overwatch.Settings.mFPSCap = value;
            }
        }
