...
{
    public class DualPanelMinorPets : ModalDialog
    {
        ...
        public static List<ObjectPicker.RowInfo> Show(List<ObjectPicker.RowInfo> sims, List<ObjectPicker.RowInfo> alreadySelectedSim, string preLocalizedSelectedCaption, string preLocalizedunselectedCaption)
        {
            ...
            using (DualPanelMinorPets dualPaneSimPicker = new DualPanelMinorPets(sims, alreadySelectedSim, preLocalizedSelectedCaption, preLocalizedunselectedCaption))
            {
        ...
        public DualPanelMinorPets(List<ObjectPicker.RowInfo> sims, List<ObjectPicker.RowInfo> alreadySelectedSim, string preLocalizedSelectedSims, string preLocalizedUnselectedSims)
        ...
        private void RepopulateSourceTable()
        {
            ...
            foreach (ObjectPicker.RowInfo current in this.mSims)
            {
                if (!this.mSelectedSims.Contains(current))
                {
                    ...
                    DualPanelMinorPets.DualPaneSimPickerRowController dualPaneSimPickerRowController = new DualPanelMinorPets.DualPaneSimPickerRowController(tableRow, this.mSourceTable, current);
        ...
        private void RepopulateSelectedSimTable()
        {
            ...
            foreach (ObjectPicker.RowInfo current in this.mSelectedSims)
            {
                ...
                DualPanelMinorPets.DualPaneSimPickerRowController rowController = new DualPanelMinorPets.DualPaneSimPickerRowController(tableRow, this.mSelectedTable, current);
        ...
        private void OnArrowClick(WindowBase sender, UIButtonClickEventArgs eventArgs)
        {
            if (sender.ID == 99576788u)
            {
                ...
                DualPanelMinorPets.DualPaneSimPickerRowController dualPaneSimPickerRowController = row.RowController as DualPanelMinorPets.DualPaneSimPickerRowController;
            ...
            else
            {
                ...
                DualPanelMinorPets.DualPaneSimPickerRowController dualPaneSimPickerRowController2 = row2.RowController as DualPanelMinorPets.DualPaneSimPickerRowController;
        ...
        private void OnGridDoubleClicked(TableContainer sender, TableRow row)
        {
            ...
            {
                DualPanelMinorPets.DualPaneSimPickerRowController dualPaneSimPickerRowController2 = row.RowController as DualPanelMinorPets.DualPaneSimPickerRowController;
