...
namespace ani_OFBStand
{
    class DualPanelShopping : ModalDialog
    {
        ...
        public static List<ObjectPicker.RowInfo> Show(List<ObjectPicker.RowInfo> items, string preLocalizedSelectedCaption, string preLocalizedunselectedCaption, float multiplyer)
        {
         
            List<ObjectPicker.RowInfo> result;
            using (DualPanelShopping dualPaneSimPicker = new DualPanelShopping(items, preLocalizedSelectedCaption, preLocalizedunselectedCaption, multiplyer))
            {
