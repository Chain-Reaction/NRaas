...
{
    public class LaserHarpPlay : Common.IPreLoad, Common.IAddInteraction
    {
        static InteractionDefinition sOldSingleton;

        public void OnPreLoad()
        {
            Tunings.Inject<LaserHarp, LaserHarp.Play.Definition, Definition>(false);

            sOldSingleton = LaserHarp.Play.Singleton;
            LaserHarp.Play.Singleton = new Definition();
        }

        public void AddInteraction(Common.InteractionInjectorList interactions)
        {
            // is this right?? It's how he has all the other instruments...
            interactions.Replace<Guitar, LaserHarp.Play.Definition>(Guitar.Play.Singleton);
        }

        protected class Definition : LaserHarp.Play.Definition
        {
