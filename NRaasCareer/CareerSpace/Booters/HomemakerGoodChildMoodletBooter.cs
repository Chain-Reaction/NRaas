...
{
    public class HomemakerGoodChildMoodletBooter : BooterHelper.TableBooter, IHomemakerBooter
    {
        static Dictionary<BuffNames, bool> sData = new Dictionary<BuffNames, bool>();

        public HomemakerGoodChildMoodletBooter()
            : base("GoodChildMoodlet", "NRaas.Homemaker", true)
        { }
        ...
        protected override void Perform(BooterHelper.BootFile file, XmlDbRow row)
        {
            ...
            BooterLogger.AddTrace(" Good Child Moodlet: " + row.GetString("Moodlet"));
        }
    }
}
