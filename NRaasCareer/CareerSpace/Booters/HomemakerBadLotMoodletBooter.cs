...
{
    public class HomemakerBadLotMoodletBooter : BooterHelper.TableBooter, IHomemakerBooter
    {
        static Dictionary<BuffNames, bool> sData = new Dictionary<BuffNames, bool>();

        public HomemakerBadLotMoodletBooter()
            : base("BadLotMoodlet", "NRaas.Homemaker", true)
        { }
