...
{
    public class HomemakerTaughtSkillBooter : BooterHelper.TableBooter, IHomemakerBooter
    {
        static Dictionary<SkillNames, bool> sData = new Dictionary<SkillNames, bool>();

        public HomemakerTaughtSkillBooter()
            : base("ValidTaughtSkill", "NRaas.Homemaker", true)
        { }
        ...
        protected override void Perform(BooterHelper.BootFile file, XmlDbRow row)
        {
            ...
            BooterLogger.AddTrace(" Taught Skill: " + row.GetString("Skill"));
        }
    }
}
