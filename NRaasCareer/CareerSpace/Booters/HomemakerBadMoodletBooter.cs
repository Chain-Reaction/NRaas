...
{
    public class HomemakerBadMoodletBooter : BooterHelper.TableBooter, IHomemakerBooter
    {
        static Dictionary<BuffNames, bool> sData = new Dictionary<BuffNames, bool>();

        public HomemakerBadMoodletBooter()
            : base("BadMoodlet", "NRaas.Homemaker", true)
        { }
        ...
        protected override void Perform(BooterHelper.BootFile file, XmlDbRow row)
        {
            ...
            BooterLogger.AddTrace(" Bad Moodlet: " + row.GetString("Moodlet"));
        }
    }
}
