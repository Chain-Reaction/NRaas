...
{
    public class SetOwnerToNone : DebugEnablerInteraction<Lot>
    {
        ...
        [DoesntRequireTuning]
        private sealed class Definition : DebugEnablerDefinition<SetOwnerToNone>
        {
            public override string GetInteractionName(IActor a, Lot target, InteractionObjectPair interaction)
            {
                return Common.Localize("SetOwnerToNone:MenuName");
            }
        }
    }
}