...
{
    public class ShowTraitsPickerDialogForUniversityGraduateTrait : DebugEnablerInteraction<Sim>
    {
        ...
        [DoesntRequireTuning]
        private class Definition : DebugEnablerDefinition<ShowTraitsPickerDialogForUniversityGraduateTrait>
        {
            public override string GetInteractionName(IActor a, Sim target, InteractionObjectPair interaction)
            {
                return Common.Localize("ShowTraitsPickerDialogForUniversityGraduateTrait:MenuName");
            }
        }
    }
}