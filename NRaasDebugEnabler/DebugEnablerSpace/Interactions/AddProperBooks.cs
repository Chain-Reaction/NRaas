...
{
    public class AddProperBooks : DebugEnablerInteraction<Bookshelf>
    {
        ...
        [DoesntRequireTuning]
        private sealed class Definition : DebugEnablerDefinition<AddProperBooks>
        {
            public override string GetInteractionName(IActor a, Bookshelf target, InteractionObjectPair interaction)
            {
                return Common.Localize("AddProperBooks:MenuName");
            }
        }
    }
}