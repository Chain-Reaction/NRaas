...
{
    public class AllowAging : DebugEnablerInteraction<Sim>
    {
        ...
        public override bool Run()
        {
            try
            {
                Target.SimDescription.AgingEnabled = !Target.SimDescription.AgingEnabled;
            }
        ...
        [DoesntRequireTuning]
        private sealed class Definition : DebugEnablerDefinition<AllowAging>
        {
            ...
            {
                return Common.Localize("AllowAging:MenuName");
            }
        }
    }
}