...
{
    public class ShowTraitsPickerDialogForSocialGroupTrait : DebugEnablerInteraction<Sim>
    {
        ...
        [DoesntRequireTuning]
        private class Definition : DebugEnablerDefinition<ShowTraitsPickerDialogForSocialGroupTrait>
        {
            public override string GetInteractionName(IActor a, Sim target, InteractionObjectPair interaction)
            {
                return Common.Localize("ShowTraitsPickerDialogForSocialGroupTrait:MenuName");
            }
        }
    }
}