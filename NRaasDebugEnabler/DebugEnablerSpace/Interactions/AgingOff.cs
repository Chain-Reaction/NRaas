...
{
    public class AgingOff : DebugEnablerInteraction<GameObject>
    {
        ...
        [DoesntRequireTuning]
        private sealed class Definition : DebugEnablerDefinition<AgingOff>
        {
            ...
            {
                return Common.Localize("AgingOff:MenuName");
            }
        }
    }
}