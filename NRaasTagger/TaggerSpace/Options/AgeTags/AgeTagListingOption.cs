...
{
    public class AgeTagListingOption : InteractionOptionList<IAgeTagOption, GameObject>
    {
        ...
        public override List<IAgeTagOption> GetOptions()
        {
            List<IAgeTagOption> results = new List<IAgeTagOption>();
