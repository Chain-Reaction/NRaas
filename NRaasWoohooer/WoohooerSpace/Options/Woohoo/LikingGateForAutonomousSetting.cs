...
namespace NRaas.WoohooerSpace.Options.Woohoo
{
    public class LikingGatingForAutonomousSetting : SpeciesIntegerSettingOption, ISpeciesOption
    {
        ...
        protected override int Value
        {
            get
            {
                return NRaas.Woohooer.Settings.mLikingGatingForAutonomousWoohoo[SpeciesIndex];
            }
            set
            {
                NRaas.Woohooer.Settings.mLikingGatingForAutonomousWoohoo[SpeciesIndex] = value;
            }
        }
