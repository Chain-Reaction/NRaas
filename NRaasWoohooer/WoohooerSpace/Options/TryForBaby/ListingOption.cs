...
{
    public class ListingOption : OptionList<ITryForBabyOption>, IPrimaryOption<GameObject>
    {
        public override string GetTitlePrefix()
        {
            return "TryForBabyInteraction";
        }
        ...
        public override List<ITryForBabyOption> GetOptions()
        {
            List<ITryForBabyOption> results = base.GetOptions();
