...
{
    public class ListingOption : OptionList<IScoringOption>, IPrimaryOption<GameObject>
    {
        public override string GetTitlePrefix()
        {
            return "ScoringInteraction";
        }
        ...
        public override List<IScoringOption> GetOptions()
        {
            List<IScoringOption> results = base.GetOptions();
