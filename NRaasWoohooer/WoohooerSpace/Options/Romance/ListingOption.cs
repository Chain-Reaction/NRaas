...
{
    public class ListingOption : OptionList<IRomanceOption>, IPrimaryOption<GameObject>
    {
        public override string GetTitlePrefix()
        {
            return "RomanceInteraction";
        }
        ...
        public override List<IRomanceOption> GetOptions()
        {
            List<IRomanceOption> results = base.GetOptions();
