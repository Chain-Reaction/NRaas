...
{
    public class MarriedInteractionLevelSetting : EnumSettingOption<MyLoveBuffLevel, GameObject>, IRomanceOption
    {
        protected override MyLoveBuffLevel Value
        {
            get
            {
                return NRaas.Woohooer.Settings.mMarriedInteractionLevel;
            }
            set
            {
                NRaas.Woohooer.Settings.mMarriedInteractionLevel = value;
            }
        }

        public override string GetTitlePrefix()
        {
            return "MarriedInteractionLevel";
        }
        ...
        {
            get { return WoohooerTuning.kMarriedInteractionLevel; }
        }
        ...
        {
            switch (NRaas.Woohooer.Settings.mMarriedInteractionLevel)
            {
