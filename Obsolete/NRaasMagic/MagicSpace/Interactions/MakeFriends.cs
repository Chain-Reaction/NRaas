...
{
    public class MakeFriends : SocialInteraction, Common.IAddInteraction
    {
        ...
        public override bool Run()
        {
            try
            {
                ...
                if (BeginSocialInteraction(new SocialInteractionB.Definition(null, Common.Localize("MakeFriends:MenuName", Actor.IsFemale), false), false, 3f, true))
                {
        ...
        public sealed class Definition : InteractionDefinition<Sim, Sim, MakeFriends>
        {
            public override string GetInteractionName(Sim a, Sim target, InteractionObjectPair interaction)
            {
                return Common.Localize("ForceFriendshipWith:MenuName", a.IsFemale);
            }
