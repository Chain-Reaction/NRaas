...
{
    public class MotiveDeltaFactor : FloatSettingOption<GameObject>, IMotiveDeltaOption
    {
        MotiveKey mKey;

        public MotiveDeltaFactor(MotiveKey key)
        {
            mKey = key;
        }
        ...
        protected override float Value
        {
            get
            {
                return Relativity.Settings.GetMotiveFactor(mKey, false);
            }
            set
            {
                Relativity.Settings.SetMotiveFactor(mKey, value);
            }
        }
