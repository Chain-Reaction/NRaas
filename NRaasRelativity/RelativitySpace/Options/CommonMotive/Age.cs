...
{
    public abstract class Age : ListedSettingOption<CASAgeGenderFlags, GameObject>
    {
        ...
        protected override List<Item> GetOptions()
        {
            ...
            foreach (CASAgeGenderFlags species in TuningAlterations.sHumanAges)
            {
        ...
        protected override bool Allow(CASAgeGenderFlags value)
        {
            ...
            return ((value & CASAgeGenderFlags.AgeMask) == value);
        }
