...
namespace Sims3.Gameplay.Objects.Beds.Mimics
{
    [Persistable]
    public class BedDoubleNebulaPlatformNRaas : Sims3.Gameplay.Objects.Beds.Mimics.BedDoubleNebulaPlatform
    {
        public BedDoubleNebulaPlatformNRaas()
        { }
