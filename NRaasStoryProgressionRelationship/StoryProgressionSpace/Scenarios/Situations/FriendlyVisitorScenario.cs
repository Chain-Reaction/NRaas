...
{
    public class FriendlyVisitorScenario : VisitorScenario
    {
        public FriendlyVisitorScenario()
        { }
        protected FriendlyVisitorScenario(FriendlyVisitorScenario scenario)
            : base (scenario)
        { }

        public override string GetTitlePrefix(PrefixType type)
        {
            return "FriendlyVisitor";
        }
        ...
        {
            return new FriendlyVisitorScenario(this);
        }

        public class Option : ChanceScenarioOptionItem<ManagerSituation, FriendlyVisitorScenario>
        {
            public Option()
                : base(20)
            { }
