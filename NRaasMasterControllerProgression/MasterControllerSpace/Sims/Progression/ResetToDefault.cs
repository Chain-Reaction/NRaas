...
namespace NRaas.MasterControllerSpace.Sims.Progression
{
    public class ResetToDefault : SimFromList, IProgressionOption
    {
        ...
        public override string Name
        {
            get
            {
                return Common.LocalizeEAString("NRaas.StoryProgression.ResetToDefault:MenuName");
            }
        }
