...
{
    public class ProgressionPersonalityLeader : SelectionTestableOptionList<ProgressionPersonalityLeader.Item, SimPersonality, string>, IDoesNotNeedSpeciesFilter
    {
        public override string GetTitlePrefix()
        {
            return "Criteria.PersonalityLeader";
        }
